...
public class VodafoneBillPage extends UtilitiesMethods {
    private AndroidDriver driver;

    public VodafoneBillPage(AndroidDriver driver) {
        this.driver = driver;
    }
    ...
    public ConfirmVodafoneBill enter_valid_data_to_pay_bill(String mobinilNumber) {
        ...
        return new ConfirmVodafoneBill(driver);
    }
}
